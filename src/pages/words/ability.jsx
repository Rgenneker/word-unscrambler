...
export default function WordAbility() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-12">
      <h1 className="text-4xl font-bold mb-4">
        ability Meaning, Definition and Word Help
      </h1>

      <p className="text-lg text-gray-700 mb-6">
        Looking for the meaning of <strong>ability</strong>? 
      ...
      <section className="mb-8">
        ...
        <p>The power or skill to do something.</p>
      </section>
