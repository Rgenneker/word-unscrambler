...
export default function WordsEndingWith() {
  ...
  const words = useMemo(() => {
    ...
    return shuffleWords(
      englishWords
        ...
        .filter((word) => word.toLowerCase().endsWith(cleanLetter))
    ).slice(0, 250);
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-300">
              Type any letter to find English words that end with that letter.
